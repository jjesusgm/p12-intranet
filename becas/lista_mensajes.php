...
$query_rsMsgsErrPlat = "SELECT * FROM msg_err_plat ORDER BY `Error` ASC";
$rsMsgsErrPlat = mysql_query($query_rsMsgsErrPlat, $conBecas) or die(mysql_error());
$row_rsMsgsErrPlat = mysql_fetch_assoc($rsMsgsErrPlat);
$totalRows_rsMsgsErrPlat = mysql_num_rows($rsMsgsErrPlat);
?>
<!DOCTYPE html>
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Becas &gt; Administracion de mensajes en plataforma</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Administración de mensajes en plataforma</h1></td>
    </tr>
    <tr>
      <td align="center"><h3 class="margin_none"><a href="mensaje_agregar.php" class="estilo3">Agregar nuevo mensaje</a></h3></td>
    </tr>
    <tr>
      <td align="center">&nbsp;</td>
    </tr>
    <tr>
      <td align="center"><table width="100%" class="TablaListaInventario">
        ...
        <?php do { ?>
          <tr>
            <td align="center"><?php echo $row_rsMsgsErrPlat['id_err']; ?></td>
            <td><?php echo $row_rsMsgsErrPlat['Error']; ?></td>
            <td align="center"><a href="mensaje_editar.php">Editar</a> | <a href="mensaje_borrar.php">Borrar</a></td>
          </tr>
          <?php } while ($row_rsMsgsErrPlat = mysql_fetch_assoc($rsMsgsErrPlat)); ?>
      </table></td>
    </tr>
    <tr>
      <td align="center">&nbsp;</td>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($rsMsgsErrPlat);
?>
