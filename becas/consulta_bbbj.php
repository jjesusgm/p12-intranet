...
<div id="div_hdr_path">&nbsp;Inicio &gt; Becas &gt; Consulta tus datos de la Beca Benito Juarez</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Consulta tus datos de la Beca Benito Juárez</h1></td>
    </tr>
  ...
  <tr>
    ...
    <table width="800" class="tabla_info_msg">
      ...
      <tr>
        <td width="40%" align="right">Código:</td>
        <td><?php echo $row_rsAlumno['codigo']; ?></td>
        </tr>
      <tr>
        <td align="right">Sede:</td>
        <td><?php echo $row_rsAlumno['sede']; ?></td>
      </tr>
      <tr>
        <td align="right">CURP:</td>
        <td><?php echo $row_rsAlumno['curp']; ?></td>
      </tr>
      <tr>
        <td align="right">Apellido 1:</td>
        <td><?php echo $row_rsAlumno['ap1']; ?></td>
      </tr>
      <tr>
        <td align="right">Apellido 2:</td>
        <td><?php echo $row_rsAlumno['ap2']; ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><?php echo $row_rsAlumno['fec_nac']; ?></td>
        </tr>
      <tr>
        <td align="right">Situación:</td>
        <td><?php echo $row_rsAlumno['situacion']; ?></td>
        </tr>
      <tr>
        <td align="right">Causa:</td>
        <td><?php echo $row_rsAlumno['causa']; ?></td>
      </tr>
      <tr>
        <td align="right">Semestre:</td>
        <td><?php echo $row_rsAlumno['semestre']; ?></td>
        </tr>
      <tr>
        <td align="right">Modalidad:</td>
        <td><?php echo $row_rsAlumno['modalidad']; ?></td>
      </tr>
      <tr>
        <td align="right">Correo:</td>
        <td><?php echo $row_rsAlumno['correo']; ?></td>
      </tr>
      <tr>
        <td align="right">Teléfono celular:</td>
        <td><?php echo $row_rsAlumno['tel_cel']; ?></td>
      </tr>
      <tr>
        <td colspan="2" align="left" bgcolor="#FFFF00">Nota: Si alguno de los datos que aquí se presentan no corresponden a tu persona o detectas alguna error, actualízalos. (Si los datos SON CORRECTOS OMITE ACTUALIZAR, ello generaría retraso en el trámite de tu beca, pues la nueva información que proporciones debe pasar por un proceso de validación en la Coordinación Nacional de Becas para el Bienestar Benito Juárez).</td>
        </tr>
      <tr>
        <td height="30" colspan="2" align="center"><a href="act_padron_bbbj.php?codigo=<?php echo $row_rsAlumno['codigo']; ?>" class="button-link">Actualiza tus datos</a></td>
      </tr>
    </table>
    </div>
    </td>
