...
<div id="div_hdr_path">&nbsp;Inicio &gt; Administración de becas</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Administración de becas</h1></td>
    </tr>
    <tr>
      <td><h3 class="H_Estilo2 margin_none">Lista de opciones</h3></td>
    </tr>
    <tr>
      <td><table width="100%">
        <tr>
          <td width="5%" align="right">-</td>
          <td><a href="lista_padron.php" class="estilo3">Actualizar el padrón de becas</a></td>
        </tr>
        <tr>
          <td align="right">-</td>
          <td><a href="lista_mensajes.php" class="estilo3">Actualizar los mensajes de la plataforma</a></td>
        </tr>
      </table></td>
    </tr>
    <tr>
