...
<div id="div_hdr_path">&nbsp;Inicio &gt; Acceso denegado</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <p>&nbsp;</p>
  <table width="600" align="center" class="tabla_error">
    <tr>
      <th colspan="2" align="left" scope="col">Mensaje del sistema</th>
    </tr>
    <tr>
      <td colspan="2"><div class="div_mensaje_alerta" align="right">Acceso denegado!!!</div></td>
    </tr>
    <tr>
      <td rowspan="2"><img src="imagenes/warning.png" width="128" height="128" alt="Alerta" /></td>
      <td>Mensaje:</td>
    </tr>
    <tr>
      <td>Estas viendo este manseje porque no tienes permisos para ver esta página. Puedes ponerte en contacto con el administrador, ir a la pagina de inicio o hacer clic en alguna de las opciones del menú.</td>
    </tr>
    <tr align="right">
      <td colspan="2"><a href="index.php">Ir al inicio</a></td>
    </tr>
  </table>
  <p>&nbsp;</p>
</div>
