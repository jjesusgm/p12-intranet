...
<div id="div_hdr_path">&nbsp;Inicio &gt; Inventario</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
<h2 class="center">Control de Inventarios</h2>
<table align="center" class="TablaEntregaNIP">
  <tr>
    <td><a href="inv_computo.php"><img src="imagenes/icono_inv_computo.png" alt="Inventario de cómputo" width="128" height="128" class="opaca" /></a></td>
    <td><a href="inv_mobiliario.php"><img src="imagenes/icono_inv_mobiliario.png" alt="Inventario de mobiliario" width="128" height="128" class="opaca" /></a></td>
  </tr>
</table>
<p class="center"><a href="../index.php" class="button-link">Regresar</a></p>
</div>
<!-- InstanceEndEditable -->
<div id="div_footer">
