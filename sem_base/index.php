...
if (isset($_POST['fRegistro'])) {
  $colname_rsAlumno = $_POST['fRegistro'];
}
mysql_select_db($database_conP12, $conP12);
$query_rsAlumno = sprintf("SELECT * FROM sem_base WHERE registro = %s", GetSQLValueString($colname_rsAlumno, "text"));
$rsAlumno = mysql_query($query_rsAlumno, $conP12) or die(mysql_error());
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Semestre Base &gt; Consulta tus datos</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Consulta de datos - Alumno Semestre Base</h1></td>
    </tr>
    <tr>
      <td align="center"><form name="form1" method="post" action="">
        <div class="DivShadowMsgLogin">
          <table width="100%" class="tabla_info_msg">
            ...
            <tr bgcolor="#FFFF00">
              <td colspan="2" align="center">NOTA 1: Escribe tu número de registro, recuerda que debe ser de 7 dígitos.</td>
            </tr>
            <tr bgcolor="#FF9900">
              <td colspan="2" align="center">NOTA 2: Si hiciste cambio de aspiración por cupo disponible, debes utilizar tu número de registro original.</td>
            </tr>
          </table>
        </div>
      </form></td>
...
<?php if ($totalRows_rsAlumno > 0) { // Show if recordset not empty ?>
    ...
    <td align="center"><div class="DivShadowMsgValidar"><table width="100%" class="TablaListaInventario">
      ...
      <tr>
        ...
        <td align="left"><?php echo $row_rsAlumno['registro']; ?></td>
        </tr>
      <tr>
        <td align="right"><strong>CICLO:</strong></td>
        <td align="left"><?php echo $row_rsAlumno['ciclo']; ?></td>
      </tr>
      <tr>
        <td align="right"><strong>NOMBRE:</strong></td>
        <td align="left"><?php echo $row_rsAlumno['nom_comp']; ?></td>
      </tr>
      <tr>
        <td align="right"><strong>GRUPO:</strong></td>
        <td align="left"><?php echo $row_rsAlumno['grupo']; ?></td>
      </tr>
      <tr>
        <td align="right"><strong>FECHA CURSO INDUCCION:</strong></td>
        <td align="left"><?php echo $row_rsAlumno['fec_ses_pre']; ?></td>
      </tr>
      <tr>
        <td align="right"><strong>HORA CURSO INDUCCION:</strong></td>
        <td align="left"><?php echo $row_rsAlumno['hor_ses_pre']; ?></td>
      </tr>
      <tr>
        <td align="right"><strong>AULA:</strong></td>
        <td align="left"><?php echo $row_rsAlumno['aula']; ?></td>
      </tr>
        </table></div></td>
  </tr>
