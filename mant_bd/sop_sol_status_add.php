...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Soporte &gt; Estatus de solicitud &gt; Agregar</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Agregar nuevo estatus de solicitud de soporte</h2>
  <form id="form1" name="form1" method="post" action="">
    <table width="500" align="center" class="tabla_usuario">
      <tr>
        <th colspan="2" align="left" scope="col">Registro del nuevo estatus</th>
      </tr>
      <tr>
        <td align="right"><label for="fStatus">Status*</label></td>
        <td><input name="fStatus" type="text" id="fStatus" size="50" maxlength="50" /></td>
      </tr>
      <tr>
        <td colspan="2" align="center"><input type="submit" name="bAgregar" id="bAgregar" value="Agregar" />
          <a href="sop_sol_status.php" class="button-link">Cancelar</a></td>
      </tr>
    </table>
  </form><br />
</div>
