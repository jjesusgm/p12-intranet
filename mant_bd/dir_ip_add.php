...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO p12_dir_ip (sub_red, dir_ip, mac_eth, mac_wifi, asignada, nombre_host, id_usuario, id_ubicacion) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
<!-- InstanceParam name="focusFormElement" type="text" value="updateIpField()" -->
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Direcciones IP &gt; Agregar</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Agregando una dirección IP</h2>
  <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    <table width="600" align="center" class="tabla_usuario">
      <tr>
        <th colspan="2" align="left" scope="col">Registro de la nueva IP</th>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="fDirIp" type="text" id="fDirIp" value="148.202.47." size="20" maxlength="15" /></td>
      </tr>
      <tr>
        <td align="right"><label for="fMacEth">MAC Ethernet</label></td>
        <td><input name="fMacEth" type="text" id="fMacEth" value="Sin asignar" size="20" maxlength="17" /></td>
      </tr>
      <tr>
        <td align="right"><label for="fMacWiFi">MAC WiFi</label></td>
        <td><input name="fMacWiFi" type="text" id="fMacWiFi" value="Sin asignar" size="20" maxlength="17" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="fNombreHost" type="text" id="fNombreHost" value="Sin asignar" size="25" maxlength="20" /></td>
      </tr>
      <tr>
...
do {  
?>
          <option value="<?php echo $row_rsUsuarios['username']?>"<?php if (!(strcmp($row_rsUsuarios['username'], "Sin asignar"))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsUsuarios['nombre_completo']?></option>
          <?php
...
do {  
?>
          <option value="<?php echo $row_rsUbicaciones['id_ubicacion']?>"<?php if (!(strcmp($row_rsUbicaciones['id_ubicacion'], "SINUBI"))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsUbicaciones['ub_nombre']?></option>
          <?php
