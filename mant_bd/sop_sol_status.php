...
$query_rsStatus = "SELECT * FROM sop_sol_status ORDER BY status ASC";
$rsStatus = mysql_query($query_rsStatus, $conP12) or die(mysql_error());
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Soporte &gt; Estatus de solicitud</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Lista de estatus de solicitud</h2>
  <h3 class="center"><a href="sop_sol_status_add.php" class="estilo3">Agregar nuevo Estatus</a></h3>
  <table width="400" align="center" class="tabla_contactos">
    ...
    <?php do { ?>
      <tr>
        <td align="center"><?php echo $row_rsStatus['id_status']; ?></td>
        <td><?php echo $row_rsStatus['status']; ?></td>
        <td align="center">Editar | Eliminar</td>
      </tr>
      <?php } while ($row_rsStatus = mysql_fetch_assoc($rsStatus)); ?>
  </table>
  <p class="center"><a href="soporte.php" class="button-link">Regresar</a></p>
</div>
<!-- InstanceEndEditable -->
<div id="div_footer">
