...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE p12_ubicaciones SET ub_nombre=%s WHERE id_ubicacion=%s",
...
if (isset($_GET['id_ubicacion'])) {
  $colname_rsUbicacion = $_GET['id_ubicacion'];
}
mysql_select_db($database_conP12, $conP12);
$query_rsUbicacion = sprintf("SELECT * FROM p12_ubicaciones WHERE id_ubicacion = %s", GetSQLValueString($colname_rsUbicacion, "text"));
$rsUbicacion = mysql_query($query_rsUbicacion, $conP12) or die(mysql_error());
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Uso general &gt; Ubicaciones &gt; Editar ubicación</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Editando ubicación</h2>
  <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    <table width="600" align="center" class="tabla_usuario">
      <tr>
        <th colspan="2" align="left" scope="col">Registro de la ubicacion a editar</th>
      </tr>
      <tr>
        <td align="right"><label for="fIdUbicacion">ID</label></td>
        <td><input name="fIdUbicacion" type="text" id="fIdUbicacion" value="<?php echo $row_rsUbicacion['id_ubicacion']; ?>" size="20" maxlength="15" readonly /></td>
      </tr>
      <tr>
        <td align="right"><label for="fUbNombre">Ubicación</label></td>
        <td><input name="fUbNombre" type="text" id="fUbNombre" value="<?php echo $row_rsUbicacion['ub_nombre']; ?>" size="65" maxlength="60" pattern="[a-zA-Z][a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]*" title="Nombre de ubicación (Formato: Combinacion de letras y numeros, no vacío" required /><span class="validity"></span></td>
      </tr>
      <tr>
        <td colspan="2" align="center"><input type="submit" name="bModificar" id="bModificar" value="Modificar" />
        <input type="button" name="fCancelar" id="fCancelar" value="Cancelar" onclick="history.back()" /></td>
      </tr>
    </table>
