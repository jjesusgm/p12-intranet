...
$query_rsTiposMonitor = "SELECT * FROM inv_computo_tipos_monitor ORDER BY tm_nombre ASC";
$rsTiposMonitor = mysql_query($query_rsTiposMonitor, $conP12) or die(mysql_error());
$row_rsTiposMonitor = mysql_fetch_assoc($rsTiposMonitor);
$totalRows_rsTiposMonitor = mysql_num_rows($rsTiposMonitor);
?>
<!DOCTYPE html>
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Inventario &gt; Cómputo &gt; Tipos de monitor</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Lista de tipos de monitor</h2>
  <h3 class="center"><a href="inv_comp_tipos_monitor_add.php" class="estilo3">Agregar nuevo tipo de monitor</a></h3>
  <table width="600" align="center" class="tabla_contactos">
    <tr>
      <th scope="col">ID</th>
      <th scope="col">TIPO DE MONITOR</th>
      <th scope="col">ACCION</th>
    </tr>
    <?php do { ?>
      <tr>
        <td align="center"><?php echo $row_rsTiposMonitor['siglas']; ?></td>
        <td><?php echo $row_rsTiposMonitor['tm_nombre']; ?></td>
        <td align="center"><a href="inv_comp_tipos_monitor_edit.php?siglas=<?php echo $row_rsTiposMonitor['siglas']; ?>">Editar</a> | <a href="inv_comp_tipos_monitor_delete.php?siglas=<?php echo $row_rsTiposMonitor['siglas']; ?>">Eliminar</a></td>
      </tr>
      <?php } while ($row_rsTiposMonitor = mysql_fetch_assoc($rsTiposMonitor)); ?>
  </table>
  <h3 class="center"><a href="inv_comp_tipos_monitor_add.php" class="estilo3">Agregar nuevo tipo de monitor</a></h3>
</div>
<!-- InstanceEndEditable -->
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($rsTiposMonitor);
?>
