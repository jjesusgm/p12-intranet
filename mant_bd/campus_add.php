...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO p12_campus (id_campus, campus) VALUES (%s, %s)",
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Campus &gt; Agregar campus</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Agregar un nuevo campus</h1></td>
    </tr>
    <tr>
      <td align="center"><form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <div class="DivShadowMsgValidar">
          <table width="550" class="tabla_info_msg">
            <tr>
              <th colspan="2" align="left" scope="col">Registro del nuevo campus</th>
              </tr>
            <tr>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td><input name="fIdCampus" type="text" id="fIdCampus" size="10" maxlength="10" title="Escribe el ID del campus" style="text-transform:uppercase;" required ><span class="validity"></span></td>
            </tr>
            <tr>
              <td align="right"><label for="fCampus">Nombre</label></td>
              <td><input name="fCampus" type="text" id="fCampus" size="50" maxlength="50" title="Escribe el nombre del campus" required><span class="validity"></span></td>
            </tr>
            <tr>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
