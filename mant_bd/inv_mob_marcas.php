...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Inventario &gt; Mobiliario &gt; Marcas</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Lista de marcas de mobiliario</h2>
  <h3 class="center"><a href="inv_mob_marcas_add.php" class="estilo3">Agregar nueva marca</a></h3>
  <table width="400" align="center" class="tabla_contactos">
    ...
    <?php do { ?>
      <tr>
        <td align="center"><?php echo $row_rsMarcas['id_marca']; ?></td>
        <td align="center"><?php echo $row_rsMarcas['marca']; ?></td>
        <td align="center"><a href="inv_mob_marcas_edit.php?id_marca=<?php echo $row_rsMarcas['id_marca']; ?>" class="estilo3">Editar</a> | <a href="inv_mob_marcas_delete.php?id_marca=<?php echo $row_rsMarcas['id_marca']; ?>" class="estilo3">Eliminar</a></td>
      </tr>
