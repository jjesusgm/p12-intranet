...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Uso general</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Bases de Datos de uso general</h2>
  <table align="center" class="TablaEntregaNIP">
    <tr>
      <td><a href="campus.php"><img src="imagenes/icono_campus.jpg" alt="Campus" title="Campus" width="128" height="128" class="opaca" /></a></td>
      <td><a href="carreras.php"><img src="imagenes/icono_carreras.png" alt="Carreras" title="Carreras" width="128" height="128" class="opaca" /></a></td>
    </tr>
    <tr>
      <td><a href="ciclos.php"><img src="imagenes/icono_ciclos.png" alt="Ciclos" title="Ciclos" width="128" height="128" class="opaca" /></a></td>
      <td><a href="ubicaciones.php"><img src="imagenes/icono_ubicaciones.jpg" alt="Ubicaciones" title="Ubicaciones" width="128" height="128" class="opaca" /></a></td>
    </tr>
  </table><br />
</div>
<!-- InstanceEndEditable -->
