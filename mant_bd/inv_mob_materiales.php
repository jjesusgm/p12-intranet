...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Inventario &gt; Mobiliario &gt; Materiales</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Lista de materiales de mobiliario</h2>
  <h3 class="center"><a href="inv_mob_materiales_add.php" class="estilo3">Agregar nuevo material</a></h3>
  <table width="400" align="center" class="tabla_contactos">
    ...
    <?php do { ?>
      <tr>
        <td align="center"><?php echo $row_rsMateriales['id_material']; ?></td>
        <td align="center"><?php echo $row_rsMateriales['material']; ?></td>
        <td align="center"><a href="inv_mob_materiales_edit.php?id_material=<?php echo $row_rsMateriales['id_material']; ?>" class="estilo3">Editar</a> | <a href="inv_mob_materiales_delete.php?id_material=<?php echo $row_rsMateriales['id_material']; ?>" class="estilo3">Eliminar</a></td>
      </tr>
      <?php } while ($row_rsMateriales = mysql_fetch_assoc($rsMateriales)); ?>
  </table>
  <h3 class="center"><a href="inv_mob_materiales_add.php" class="estilo3">Agregar nuevo material</a></h3>
</div>
<!-- InstanceEndEditable -->
