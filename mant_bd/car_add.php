...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO p12_carreras (id_carrera, carrera) VALUES (%s, %s)",
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Carreras &gt; Agregar una carrera</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Agregando un registro de carrera</h2>
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table width="600" align="center" class="tabla_usuario">
      <tr>
        <th colspan="2" align="left" scope="col">Información del registo por agregar</th>
      </tr>
      <tr>
        <td align="right"><label for="fIdCarrera">Siglas*</label></td>
        <td><input name="fIdCarrera" type="text" id="fIdCarrera" size="15" maxlength="10" /></td>
      </tr>
      <tr>
        <td align="right"><label for="fCarrera">Carrera*</label></td>
        <td><input name="fCarrera" type="text" id="fCarrera" size="80" maxlength="100" /></td>
      </tr>
      <tr>
