...
if ((isset($_GET['fIdCarrera'])) && ($_GET['fIdCarrera'] != "")) {
  $deleteSQL = sprintf("DELETE FROM p12_carreras WHERE id_carrera=%s",
                       GetSQLValueString($_GET['fIdCarrera'], "text"));

  mysql_select_db($database_conP12, $conP12);
  $Result1 = mysql_query($deleteSQL, $conP12) or die(mysql_error());

  $deleteGoTo = "carreras.php";
...
if (isset($_GET['id_carrera'])) {
  $colname_rsCarrera = $_GET['id_carrera'];
}
mysql_select_db($database_conP12, $conP12);
$query_rsCarrera = sprintf("SELECT * FROM p12_carreras WHERE id_carrera = %s", GetSQLValueString($colname_rsCarrera, "text"));
$rsCarrera = mysql_query($query_rsCarrera, $conP12) or die(mysql_error());
$row_rsCarrera = mysql_fetch_assoc($rsCarrera);
$totalRows_rsCarrera = mysql_num_rows($rsCarrera);
?>
<!DOCTYPE html>
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Usuarios &gt; Carreras &gt; Eliminar carrera</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Eliminando una carrera</h2>
  <form action="" method="get" name="form1" id="form1">
    <table width="600" align="center" class="tabla_usuario">
      <tr>
        <th colspan="3" align="left" scope="col">Registro de la carrera a eliminar</th>
      </tr>
      <tr>
        <td width="128" rowspan="3"><img src="../imagenes/warning.png" width="128" height="128" alt="Advertencia" /></td>
        <td colspan="2" align="center">ADVERTENCIA: Esta a punto de eliminar el registro de esta carrera, ¿desea continuar?</td>
      </tr>
      <tr>
        <td align="right"><label for="fIdCarrera">Siglas</label></td>
        <td><input name="fIdCarrera" type="text" id="fIdCarrera" value="<?php echo $row_rsCarrera['id_carrera']; ?>" size="10" maxlength="10" readonly /></td>
      </tr>
      <tr>
        <td align="right"><label for="fCarrera">Carrera</label></td>
        <td><input name="fCarrera" type="text" id="fCarrera" value="<?php echo $row_rsCarrera['carrera']; ?>" size="70" maxlength="100" readonly /></td>
      </tr>
      <tr>
        <td colspan="3" align="center"><input type="submit" name="bContinuar" id="bContinuar" value="Continuar" />
