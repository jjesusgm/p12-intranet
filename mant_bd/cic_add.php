...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO p12_ciclos (id_ciclo, ciclo) VALUES (%s, %s)",
                       GetSQLValueString($_POST['fIdCiclo'], "int"),
                       GetSQLValueString($_POST['fCiclo'], "text"));

  mysql_select_db($database_conP12, $conP12);
  $Result1 = mysql_query($insertSQL, $conP12) or die(mysql_error());

  $insertGoTo = "ciclos.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Uso general &gt; Ciclos &gt; Agregar un ciclo</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Agregando un registro de ciclo</h2>
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table width="400" align="center" class="tabla_usuario">
      <tr>
        <th colspan="2" align="left" scope="col">Información del registro por agregar</th>
      </tr>
      <tr>
        <td align="right"><label for="fIdCiclo">ID Ciclo*</label></td>
        <td><input name="fIdCiclo" type="text" id="fIdCiclo" size="10" maxlength="6" /></td>
      </tr>
      <tr>
        <td align="right"><label for="fCiclo">Ciclo*</label></td>
        <td><input name="fCiclo" type="text" id="fCiclo" size="10" maxlength="10" /></td>
      </tr>
      <tr>
