...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Inventario &gt; Mobiliario &gt; Tipos de mobiliario</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Lista de tipos de mobiliario</h2>
  <h3 class="center"><a href="inv_mob_tipos_add.php" class="estilo3">Agregar nuevo tipo</a></h3>
  <table width="400" align="center" class="tabla_contactos">
    ...
    <?php do { ?>
      <tr>
        <td align="center"><?php echo $row_rsTipos['id_tipo_mobiliario']; ?></td>
        <td align="center"><?php echo $row_rsTipos['tipo_mobiliario']; ?></td>
        <td align="center"><a href="inv_mob_tipos_edit.php?id_tipo_mobiliario=<?php echo $row_rsTipos['id_tipo_mobiliario']; ?>" class="estilo3">Editar</a> | <a href="inv_mob_tipos_delete.php?id_tipo_mobiliario=<?php echo $row_rsTipos['id_tipo_mobiliario']; ?>" class="estilo3">Eliminar</a></td>
      </tr>
