...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO usr_niveles_acceso (nivel_de_acceso) VALUES (%s)",
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Niveles de acceso &gt; Agregar</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Agregando nivel de acceso</h2>
  <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    <table width="350" align="center" class="tabla_usuario">
      <tr>
        <th colspan="2" align="left" scope="col">Registro del nuevo nivel de acceso</th>
      </tr>
      <tr>
        <td align="right"><label for="fNivelDeAcceso">Nivel de acceso</label></td>
        <td><input name="fNivelDeAcceso" type="text" id="fNivelDeAcceso" size="20" maxlength="15" /></td>
      </tr>
      <tr>
        <td colspan="2" align="center"><input type="submit" name="bAgregar" id="bAgregar" value="Agregar" />
          <a href="niv_acceso.php" class="button-link">Cancelar</a></td>
      </tr>
    </table>
