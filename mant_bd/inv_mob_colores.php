...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Inventario &gt; Mobiliario &gt; Colores</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Lista de colores de mobiliario</h2>
  <h3 class="center"><a href="inv_mob_colores_add.php" class="estilo3">Agregar nuevo color</a></h3>
  <table width="400" align="center" class="tabla_contactos">
    ...
    <?php do { ?>
      <tr>
        <td align="center"><?php echo $row_rsColores['id_color']; ?></td>
        <td align="center"><?php echo $row_rsColores['color']; ?></td>
        <td align="center"><a href="inv_mob_colores_edit.php?id_color=<?php echo $row_rsColores['id_color']; ?>" class="estilo3">Editar</a> | <a href="inv_mob_colores_delete.php?id_color=<?php echo $row_rsColores['id_color']; ?>" class="estilo3">Eliminar</a></td>
      </tr>
      <?php } while ($row_rsColores = mysql_fetch_assoc($rsColores)); ?>
  </table>
  <h3 class="center"><a href="inv_mob_colores_add.php" class="estilo3">Agregar nuevo color</a></h3>
</div>
<!-- InstanceEndEditable -->
