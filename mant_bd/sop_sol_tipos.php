...
$query_rsTipos = "SELECT t.*, na.nivel_de_acceso FROM sop_sol_tipos t INNER JOIN usr_niveles_acceso na ON t.id_nivel_acceso = na.id_nivel_acceso ORDER BY tipo_sol ASC";
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Soporte &gt; Tipos de solicitud</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Lista de tipos de solicitud</h2>
  <h3 class="center"><a href="sop_sol_tipos_add.php" class="estilo3">Agregar nuevo tipo</a></h3>
  <table width="650" align="center" class="tabla_contactos">
    <tr>
      <th scope="col">ID</th>
      <th scope="col">NIV. ACCESO</th>
      <th scope="col">TIPO</th>
      <th scope="col">ACCION</th>
    </tr>
    <?php do { ?>
      <tr>
        <td align="center"><?php echo $row_rsTipos['id_tipo_sol']; ?></td>
        <td align="center"><?php echo $row_rsTipos['nivel_de_acceso']; ?></td>
        <td><?php echo $row_rsTipos['tipo_sol']; ?></td>
        <td align="center"><a href="sop_sol_tipos_edit.php?id_tipo_sol=<?php echo $row_rsTipos['id_tipo_sol']; ?>" class="estilo3">Editar</a> | <a href="sop_sol_tipos_delete.php?id_tipo_sol=<?php echo $row_rsTipos['id_tipo_sol']; ?>" class="estilo3">Eliminar</a></td>
      </tr>
      <?php } while ($row_rsTipos = mysql_fetch_assoc($rsTipos)); ?>
  </table><p class="center"><a href="soporte.php" class="button-link">Regresar</a></p>
</div>
<!-- InstanceEndEditable -->
<div id="div_footer">
