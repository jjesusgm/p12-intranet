...
if (isset($_GET['id_campus'])) {
  $colname_rsCampus = $_GET['id_campus'];
}
mysql_select_db($database_conP12, $conP12);
$query_rsCampus = sprintf("SELECT * FROM p12_campus WHERE id_campus = %s", GetSQLValueString($colname_rsCampus, "text"));
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Campus &gt; Editar campus</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Editar un  campus</h1></td>
    </tr>
    <tr>
      <td align="center"><form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <div class="DivShadowMsgValidar">
          <table width="550" class="tabla_info_msg">
            <tr>
              <th colspan="2" align="left" scope="col">Registro del  campus</th>
              </tr>
            <tr>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td align="right"><label for="fIdCampus">ID </label></td>
              <td><input name="fIdCampus" type="text" required id="fIdCampus" style="text-transform:uppercase;" title="Escribe el ID del campus" value="<?php echo $row_rsCampus['id_campus']; ?>" size="10" maxlength="10" ><span class="validity"></span></td>
            </tr>
            <tr>
              <td align="right"><label for="fCampus">Nombre</label></td>
              <td><input name="fCampus" type="text" required id="fCampus" title="Escribe el nombre del campus" value="<?php echo $row_rsCampus['campus']; ?>" size="50" maxlength="50"><span class="validity"></span></td>
            </tr>
            <tr>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td colspan="2" align="right"><input type="submit" name="bEnviar" id="bEnviar" value="Enviar">
                ...
                <a href="campus.php" class="button-link">Cancelar</a></td>
              </tr>
          </table>
        </div>
