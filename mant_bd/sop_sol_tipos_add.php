...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO sop_sol_tipos (id_nivel_acceso, tipo_sol) VALUES (%s, %s)",
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Soporte &gt; Tipos de solicitud &gt; Agregar</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Agregando nuevo tipo de solicitud de soporte</h2>
  <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    <table width="500" align="center" class="tabla_usuario">
      <tr>
        <th colspan="2" align="left" scope="col">Registro del nuevo tipo</th>
      </tr>
      <tr>
...
do {  
?>
          <option value="<?php echo $row_rsNivelesAcceso['id_nivel_acceso']?>"><?php echo $row_rsNivelesAcceso['nivel_de_acceso']?></option>
          <?php
...
?>
      ...
      <tr>
        ...
        <td><input name="fTipoSol" type="text" id="fTipoSol" size="55" maxlength="50" /></td>
      </tr>
      <tr>
