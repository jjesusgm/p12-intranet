...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO nrc_list (id_nrc, ua, id_profesor) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['fNrc'], "int"),
                       GetSQLValueString($_POST['fUa'], "text"),
                       GetSQLValueString($_POST['fIdProfesor'], "text"));

  mysql_select_db($database_conP12, $conP12);
  $Result1 = mysql_query($insertSQL, $conP12) or die(mysql_error());

  $insertGoTo = "lista_nrc.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="div_contenido">
  <h2 class="center">Agregando un nuevo NRC</h2>
  <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    <table width="600" align="center" class="tabla_usuario">
      <tr>
        <th colspan="2" align="left" scope="col">Registro del nuevo NRC</th>
      </tr>
      <tr>
        <td align="right"><label for="fNrc">NRC*</label></td>
        <td><input name="fNrc" type="text" id="fNrc" size="10" maxlength="8" placeholder="Escribe el NRC" /></td>
      </tr>
      <tr>
        <td align="right"><label for="fUa">UA*</label></td>
        <td><input name="fUa" type="text" id="fUa" size="50" maxlength="50" placeholder="Escribe la Unidad de Aprendizaje" /></td>
      </tr>
      <tr>
        <td align="right"><label for="fIdProfesor">Profesor*</label></td>
        <td><select name="fIdProfesor" id="fIdProfesor">
          <?php
do {  
?>
...
?>
      ...
      <tr>
        ...
        <a href="lista_nrc.php" class="button-link">Cancelar</a></td>
      </tr>
    </table>
