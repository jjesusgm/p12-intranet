...
$query_rsTipos = "SELECT * FROM inv_computo_tipos ORDER BY tipo_dispositivo ASC";
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Inventario &gt; Cómputo &gt; Tipos de dispositivo</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Lista de tipos de dispositivos de cómputo</h2>
  <h3 class="center"><a href="inv_comp_tipos_add.php" class="estilo3">Agregar nuevo tipo</a></h3>
  <table width="500" align="center" class="tabla_contactos">
    <tr>
      <th scope="col">ID</th>
    ...
    <?php do { ?>
      <tr>
        <td align="center"><?php echo $row_rsTipos['id_tipo_dispositivo']; ?></td>
        <td><?php echo $row_rsTipos['tipo_dispositivo']; ?></td>
        <td align="center"><a href="inv_comp_tipos_edit.php?id_tipo_dispositivo=<?php echo $row_rsTipos['id_tipo_dispositivo']; ?>" class="estilo3">Editar</a> | <a href="inv_comp_tipos_delete.php?id_tipo_dispositivo=<?php echo $row_rsTipos['id_tipo_dispositivo']; ?>" class="estilo3">Eliminar</a></td>
      </tr>
