...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO inv_computo_tipos_monitor (siglas, tm_nombre) VALUES (%s, %s)",
  ...
  $insertGoTo = "inv_comp_tipos_monitor.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Inventario &gt; Cómputo &gt; Tipos de monitor &gt; Agregar</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Agregando nuevo tipo</h2>
  <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    <table width="450" align="center" class="tabla_usuario">
      <tr>
        <th colspan="2" align="left" scope="col">Registro del nuevo tipo</th>
      </tr>
      <tr>
        <td align="right"><label for="fSiglas">Siglas*</label></td>
        <td><input name="fSiglas" type="text" id="fSiglas" size="15" maxlength="10" /></td>
      </tr>
      <tr>
        <td align="right"><label for="fTMNombre">Tipo*</label></td>
        <td><input name="fTMNombre" type="text" id="fTMNombre" size="45" maxlength="40" /></td>
      </tr>
      <tr>
