...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE p12_carreras SET carrera=%s WHERE id_carrera=%s",
                       GetSQLValueString($_POST['fCarrera'], "text"),
                       GetSQLValueString($_POST['fIdCarrera'], "text"));

  mysql_select_db($database_conP12, $conP12);
  $Result1 = mysql_query($updateSQL, $conP12) or die(mysql_error());

  $updateGoTo = "carreras.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conP12, $conP12);
$query_rsCarrera = "SELECT * FROM p12_carreras";
$rsCarrera = mysql_query($query_rsCarrera, $conP12) or die(mysql_error());
$row_rsCarrera = mysql_fetch_assoc($rsCarrera);
?>
<!DOCTYPE html>
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Usuarios &gt; Carreras &gt; Modificar carrera</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Modificando una carrera</h2>
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table width="600" align="center" class="tabla_usuario">
      <tr>
        <th colspan="2" align="left" scope="col">Registro de la Carrera a modificar</th>
      </tr>
      <tr>
        <td align="right"><label for="fIdCarrera">Siglas</label></td>
        <td><input name="fIdCarrera" type="text" id="fIdCarrera" value="<?php echo $row_rsCarrera['id_carrera']; ?>" size="15" maxlength="10" readonly /></td>
      </tr>
      <tr>
        <td align="right"><label for="fCarrera">Carrera*</label></td>
        <td><input name="fCarrera" type="text" id="fCarrera" value="<?php echo $row_rsCarrera['carrera']; ?>" size="80" maxlength="100" /></td>
      </tr>
      <tr>
