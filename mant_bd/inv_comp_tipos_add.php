...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO inv_computo_tipos (tipo_dispositivo) VALUES (%s)",
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mantenimiento a BD &gt; Inventario &gt; Cómputo &gt; Tipos de dispositivo &gt; Agregar</div>
  ...
  <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    <table width="400" align="center" class="tabla_usuario">
      ...
      <tr>
        ...
        <td><input name="fTipoDispositivo" type="text" id="fTipoDispositivo" size="35" maxlength="30" /></td>
      </tr>
      <tr>
