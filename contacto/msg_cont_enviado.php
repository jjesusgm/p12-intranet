...
<div id="div_hdr_path">&nbsp;Inicio &gt; Contacto &gt; Enviado</div>
...
<div id="div_contenido">
  <table width="90%" align="center">
    ...
    <tr>
      <td><div class="DivShadowMsgValidar">
        <table width="550" class="tabla_info_msg">
          <tr>
            <th colspan="2" align="left" scope="col">Mensaje del sistema</th>
          </tr>
          <tr>
            <td width="128" align="center"><img src="../imagenes/info.png" width="128" height="128" alt="Información"></td>
            <td>Tu mensaje de contacto se envió corectamente, muy pronto recibirás respuesta del equipo de soporte.</td>
          </tr>
          <tr>
            <td height="40" colspan="2" align="right" valign="middle"><a href="../index.php" class="button-link">Continuar</a>&nbsp;</td>
          </tr>
        </table>
      </div></td>
    </tr>
