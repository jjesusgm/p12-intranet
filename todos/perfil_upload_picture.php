...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mi perfil &gt; Subir foto</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
<br />
  <table width="600" align="center" class="TablaEntregaNIP">
    <tr>
      <th colspan="2" align="left" scope="col">INSTRUCCIONES GENERALES</th>
    </tr>
    <tr>
      <td align="center">Obligatorio</td>
      <td>El archivo debe medir máximo 500 KB.</td>
    </tr>
    <tr>
      <td align="center">Obligatorio</td>
      <td>El archivo debe tener extensión JPG, JPEG, PNG ó GIF.</td>
    </tr>
    <tr>
      <td align="center">Opcional</td>
      <td>Dimensiones recomendadas: Ancho=200px, Alto=250px.</td>
    </tr>
    <tr>
      <th colspan="2" align="left">PASOS PARA SUBIR LA FOTO</th>
    </tr>
    <tr>
      <td align="center">1</td>
      <td>Seleccionar el archivo utilizando el botón &quot;Examinar&quot;.</td>
    </tr>
    <tr>
      <td align="center">2</td>
      <td>Hacer clic en el botón &quot;Subir foto&quot;.</td>
    </tr>
  </table>
  <br />
  <form action="../upload.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
    <table align="center">
      <tr>
        <td><input name="fileToUpload" type="file" id="fileToUpload" size="70" /></td>
        <td><input type="submit" name="submit" id="submit" value="Subir foto" /></td>
      </tr>
    </table>
  </form><p class="center"><a href="perfil_edit.php" class="button-link">Regresar</a></p>
</div>
<!-- InstanceEndEditable -->
<div id="div_footer">
