...
<div id="div_hdr_path">&nbsp;Inicio &gt; Mi perfil</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido"><br />
  <table border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><div class="div_fldr_tab">Perfil</div></td>
      <td><div class="div_fldr_tab"><a href="perfil_edit.php">Editar información</a></div></td>
      <td><div class="div_fldr_tab">Mensajes</div></td>
    </tr>
  </table>
  <div class="div_fldr"><table width="100%" align="center" class="TablaViewProfile">
    <tr>
      <td width="200" rowspan="8" align="center">
      <?php if(file_exists("../imagenes/perfiles/".$row_rsProfesor['username'].".jpg")){
      	echo "<img src='../imagenes/perfiles/".$row_rsProfesor['username'].".jpg' class='img_borde2' alt='Foto del usuario' name='foto_usuario' width='200' height='250' id='foto_usuario' />";
      } else {
      	echo "<img src='../imagenes/perfiles/sin_foto.png' class='img_borde2' alt='Foto del usuario' name='foto_usuario' width='200' height='250' id='foto_usuario' />";
      } ?>
      </td>
      <th align="right">Usuario:</th>
      <td><?php echo $row_rsProfesor['username']; ?></td>
    </tr>
    <tr>
      <th align="right">Nombre completo:</th>
      <td><?php echo $row_rsProfesor['nombre_completo']; ?></td>
    </tr>
    <tr>
      <th align="right">Tipo  usuario:</th>
      <td><?php echo $row_rsProfesor['nivel_de_acceso']; ?></td>
    </tr>
    <tr>
      <th align="right"> E-mail:</th>
      <td><?php echo $row_rsProfesor['email']; ?></td>
    </tr>
    <tr>
      <th align="right">Ultimo acceso:</th>
      <td><?php echo $row_rsProfesor['ultimo_acceso']; ?></td>
    </tr>
    <tr>
      <th align="right">Genero:</th>
      <td><?php echo $row_rsProfesor['genero']; ?></td>
    </tr>
    <tr>
      <th align="right">Tipo de NIP:</th>
      <td><?php echo $row_rsProfesor['nip_tipo']; ?></td>
    </tr>
    <tr>
      <th align="right">Campus:</th>
      <td><?php echo $row_rsProfesor['campus']; ?></td>
    </tr>
    <tr>
      <td height="30" colspan="3" align="center"><a href="sol_cambio_nip.php" class="button-link">Solicitar cambio de contraseña</a></td>
      </tr>
  </table>
  </div><p class="center"><a href="../index.php" class="button-link">Regresar</a></p>
</div>
<!-- InstanceEndEditable -->
<div id="div_footer">
