...
if ((isset($_GET['fUserName'])) && ($_GET['fUserName'] != "")) {
  $deleteSQL = sprintf("DELETE FROM usuarios WHERE username=%s",
                       GetSQLValueString($_GET['fUserName'], "text"));
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Usuarios &gt; Eliminar usuario</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h2 class="center">Eliminando un usuario</h2>
  <form action="" method="get" name="form1" id="form1">
    <table width="600" align="center" class="tabla_usuario">
      <tr>
        <th colspan="3" align="left" scope="col">Registro del usuario a eliminar</th>
      </tr>
      <tr>
        <td width="128" rowspan="3"><img src="../imagenes/warning.png" width="128" height="128" alt="Advertencia" /></td>
        <td colspan="2" align="center">ADVERTENCIA: Esta a punto de eliminar el registro de este usuario, ¿desea continuar?</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="fNombreCompleto" type="text" id="fNombreCompleto" value="<?php echo $row_rsUsuario['nombre_completo']; ?>" size="60" maxlength="100" readonly /></td>
      </tr>
      <tr>
