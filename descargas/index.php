...
<div id="div_hdr_path">&nbsp;Inicio &gt; Descargas</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Descargas</h1></td>
    </tr>
    <tr>
      <td><table width="100%">
        <tr>
          <td width="3%" align="right">&gt;</td>
          <td><a href="software/adobe_cs6.zip" target="_blank">Adobe Suite CS6</a></td>
        </tr>
        <tr>
          <td width="3%" align="right">&gt;</td>
          <td><a href="software/dw_cs6_portable_es.zip" target="_blank">Dreamweaver CS6 Portable</a></td>
        </tr>
        <tr>
          <td width="3%" align="right">&gt;</td>
          <td><a href="software/OpenShotPortable_2.6.1.paf.exe" target="_blank">OpenShot Portable</a></td>
        </tr>
        <tr>
          <td align="right">&gt;</td>
          <td><a href="software/xampp.zip" target="_blank">XAMPP</a></td>
        </tr>
        <tr>
          <td align="right">&gt;</td>
          <td><a href="videos/los_piratas_de_silicon_valley.avi" target="_blank">Video: Los piratas de Silicon Valley</a></td>
        </tr>
      </table></td>
    </tr>
    <tr>
