...
<div id="div_hdr_path">&nbsp;Inicio &gt; Página no encontrada</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <h1 class="center">404 PAGINA NO ENCONTRADA</h1>
  <p class="center">La página que buscas no existe. Haz clic <a href="index.php" class="estilo3">aqui</a> para regresar a la página principal.</p>
  <p class="center">Si llegaste e esta página haciendo clic en un enlace, por favor avisanos para corregir este problema.</p>
</div>
<!-- InstanceEndEditable -->
<div id="div_footer">
