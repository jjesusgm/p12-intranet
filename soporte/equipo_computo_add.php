...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "bitacora_computo_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Soporte &gt; Bitácoras cómputo &gt; Agregar equipo de cómputo</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Agregar un equipo de cómputo</h1></td>
    </tr>
    <tr>
      <td><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="return valida(this)">
        <table align="center" class="tabla_usuario">
          <tr>
            <th colspan="2" align="left" scope="col">Registro del equipo de cómputo</th>
          </tr>
          <tr>
...
?>
          ...
          <tr>
            <td colspan="2" align="center"><input type="submit" name="bAgregar" id="bAgregar" value="Agregar" />
              ...
              <a href="bitacora_computo_list.php" class="button-link">Cancelar</a></td>
          </tr>
        </table>
